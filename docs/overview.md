...
- Runtime: TypeScript/Bun in Docker Compose, started from `src/index.ts`
...
Docker Compose is the only supported production path. Shared infrastructure and credentials live outside this repository.
